...
| OWED | the VM boot result (running detached on isle-core: UEFI OVMF, 3 GB RAM, serial log); the probe kit on a real Windows and Mac; Ventoy on a real stick; D-P4 join tokens; the redeploy carrying the built-in fix |
