...
| deploy | ❌ NOT deployed, NOT browser-verified — needs pspp+foodstate in POLARI_MODULES on prf-a, image build + service update, then the browser pass (live findings expected, every arc has them) |
